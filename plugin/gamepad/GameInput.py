...
A ctypes wrapper around Microsoft's GameInput.h (API version 3 / the GameInputRedist.dll redistributable).
"""
...
#
# All inherit from IUnknown, so interface-specific methods start at index 3. 
# ============================================================================
...
# ============================================================================
# Entry Point interface creation
# ============================================================================

def create_gameinput(path=GAMEINPUT_REDIST_PATH):
    """Call GameInputInitialize and return the raw IGameInput interface pointer (c_void_p)."""
    dll = load_dll(path)
